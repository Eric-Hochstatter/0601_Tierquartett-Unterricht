const data = [
	...
	},
	{
		...
		trivia: "The cheetah cannot roar and is unable to retract its claws.",
		group: "A",
		groupname_german: "Raubtiere",
		groupname: "Predators",
		group_number: 2,
	...
	},
	{
		...
		name_german: "Papagei",
		trivia_german:
			"Einige Papageienarten, wie der Kakadu, sind in der Lage, Werkzeuge zu verwenden.",
		trivia: "Some parrot species, like the cockatoo, are capable of using tools.",
		group: "B",
		groupname_german: "Vogel",
		groupname: "Birds",
		group_number: 1,
		name: "Parrot",
		max_weight: "0,5",
		...
		max_length: 50,
		litter_size: 3,
		continents: "Americas, Australia, Africa, Asia",
		intelligence: 10,
	},
	{
		id: 6,
...
{
		id: 14,
		name_german: "Königskrabbe",
		trivia_german:
			"Die Rote Königskrabbe kann eine Beinspannweite von bis zu fünf Fuß erreichen",
		trivia: "The red king crab can reach a leg span of up to five feet.",
		group: "D",
		groupname_german: "Meeresbewohner",
		groupname: "Sea Creatures",
		group_number: 2,
